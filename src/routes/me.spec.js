...
describe('#meRoute', function() {
  ...
  it(`calls geoip with user ip and responds with country`, async function() {
    // given
    ...
    sinon.assert.calledOnceWithExactly(res.json, { country: 'FR' })
  })

  it(`calls geoip with ip from user behind proxy and responds with country`, async function() {
    // given
    ...
    sinon.assert.calledOnceWithExactly(res.json, { country: 'BE' })
  })
